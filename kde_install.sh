...
#Styling
clear
echo "Richte KDE Hintergrundbild ein / Setting up Gnome backgroundimage"
...
gsettings set org.kde.desktop.interface icon-theme Papirus
gsettings set org.kde.desktop.interface gtk-theme Arc-Dark
gsettings set org.kde.theme name Arc-Dark
gsettings set org.kde.desktop.input-sources sources "[('xkb', 'de')]"
gsettings set org.kde.desktop.interface monospace-font-name 'Monospace 11'
gsettings set org.kde.desktop.background picture-uri 'file:///usr/share/backgrounds/1440-VCF-1.jpg'
...
cat <<EOL > ~/.config/autostart/set-kde-theme.desktop
[Desktop Entry]
Type=Application
Exec=/home/$USER/set-kde-theme.sh
Name=Set KDE Theme
Comment=Set the default Kde theme after login
