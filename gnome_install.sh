...
sudo cp ~/void/1440-VCF-1.jpg /usr/share/backgrounds/
...
sudo xbps-install -y NetworkManager NetworkManager-openvpn NetworkManager-openconnect NetworkManager-vpnc NetworkManager-l2tp network-manager-applet ntp
...
sudo xbps-install -y octoxbps gnome-core xdg-desktop-portal xdg-desktop-portal-gtk xdg-user-dirs xdg-user-dirs-gtk xdg-desktop-portal-wlr xdg-utils xdg-desktop-portal-kde gnome-keyring sushi nautilus-gnome-console-extension wget bash-completion libva-vdpau-driver curl ffmpeg mesa-vdpau mesa-vaapi autoconf automake bison m4 make libtool linux-headers extension-manager chrome-gnome-shell
sleep 1

#Druckerunterstuetzung / Printersupport
clear
echo "Install Printer..."
sudo xbps-install -y cups cups-filters gutenprint cups-pk-helper
...
sudo xbps-install -y exfat-utils fuse-exfat gvfs-afc gvfs-mtp gvfs-smb udisks2 ntfs-3g gptfdisk bluez AppStream libva-vdpau-driver vdpauinfo autofs
...
sudo xbps-install -y firefox firefox-i18n-de gnome-console tumbler
sleep 1
